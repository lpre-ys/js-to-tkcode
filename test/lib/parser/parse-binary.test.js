...
describe('Parser parseBinary', () => {
  ...
  describe('変数を含む計算', () => {
    it('左辺が変数、右辺がリテラル', () => {
      ...
      assert(parser.outputs[0] == 'Variable(0, 101, 101, 0, 1, 43, 0)');
      assert(parser.outputs[1] == 'Variable(0, 101, 101, 1, 0, 2, 0)');
    });
    it('左辺が定数、右辺がリテラル', () => {
      ...
      assert(parser.outputs[0] == 'Variable(0, 101, 101, 0, 0, 2, 0)');
      assert(parser.outputs[1] == 'Variable(0, 101, 101, 1, 1, 43, 0)');
    });
    it('変数と変数', () => {
      ...
      assert(parser.outputs[0] == 'Variable(0, 101, 101, 0, 1, 43, 0)');
      assert(parser.outputs[1] == 'Variable(0, 101, 101, 1, 1, 44, 0)');
    });
  });
