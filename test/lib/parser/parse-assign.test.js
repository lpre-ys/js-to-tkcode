...
describe('Parser parseAssign', () => {
  describe('シンプルな代入', () => {
    it('定数', () => {
      ...
      const outputs = [];
      parseAssign(node, outputs);

      assert(outputs[0] == "Variable(0, 42, 42, 0, 0, 1, 0)");
    ...
    it('変数', () => {
      ...
      assert(outputs[0] == "Variable(0, 42, 42, 0, 1, 43, 0)");
    ...
    it('一時変数', () => {
      ...
      assert(outputs[0] == "Variable(0, 101, 101, 0, 0, 1, 0)");
    ...
    describe('スイッチ(boolean)', () => {
      it('true', () => {
        ...
        assert(outputs[0] == `Switch(0, 21, 21, 0)`);
      ...
      it('false', () => {
        ...
        assert(outputs[0] == `Switch(0, 21, 21, 1)`);
  ...
  describe('複合代入演算子', () => {
    describe('リテラル', () => {
      it('足し算', () => {
        ...
        assert(outputs[0] == `Variable(0, 42, 42, 1, 0, 37, 0)`);
      ...
      it('引き算', () => {
        ...
        assert(outputs[0] == `Variable(0, 42, 42, 2, 0, 37, 0)`);
      ...
      it('掛け算', () => {
        ...
        assert(outputs[0] == `Variable(0, 42, 42, 3, 0, 37, 0)`);
      ...
      it('割り算', () => {
        ...
        assert(outputs[0] == `Variable(0, 42, 42, 4, 0, 37, 0)`);
      ...
      it('余り', () => {
        ...
        assert(outputs[0] == `Variable(0, 42, 42, 5, 0, 37, 0)`);
